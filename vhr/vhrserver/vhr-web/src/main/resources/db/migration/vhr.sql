...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES (1, '江南一点雨', '男', '1990-01-01', '610122199001011256', '已婚', 1, '陕西', 13, 'laowang@qq.com', '18565558898', '深圳市南山区', 5, 9, 29, '劳务合同', '本科', '信息管理与信息系统', '深圳大学', '2018-01-01', '在职', '00000001', 2, '2018-04-01', NULL, '2018-01-01', '2020-01-01', NULL);
...
-- ----------------------------
INSERT INTO `flyway_schema_history` VALUES (1, '1', 'vhr', 'SQL', 'V1__vhr.sql', -1039138481, 'root', '2020-09-11 19:14:57', 353, 1);
