<template>
  <div>
    <div style="displau: flex; justify-content: space-between">
      ...
      <el-table :data="salaries" border stripe>
        ...
        <el-table-column label="操作" width="300">
          <template slot-scope="scope">
            ...
            <el-button type="danger" @click="deleteSalaryView(scope.row)"
              >删除</el-button
            >
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    deleteSalaryView(data) {
      this.$confirm("此操作将删除[" + data.name + "]套账,是否继续?", "提示", {
        cancelButtonText: "取消",
